...
export const ChapterDetailPage: React.FC = () => {
  ...
  const [currentChapter, setCurrentChapter] = useState<ApiChapterDetail | null>(
    null,
  );
  const [chapters, setChapters] = useState<ChapterApiResponse[]>([]);
  ...
  const formattedChapterData: ChapterDetailData | null = useMemo(() => {
